...
SOCIAL_SOURCES = "weibo.com,zhihu.com,toutiao.com,bilibili.com"

class AnspireSearchClient(BaseSearchClient):
    """Anspire Web 检索 Provider 实现"""

    def __init__(self):
        """读取Anspire 秘钥与地址并构建请求头"""
        super().__init__()
    ...
    @with_retry
    async def _execute_search(self, query:str, top_k:int, insite:str='', from_time:str='', to_time:str='',)->SearchProviderResponse:
        """组装参数发起GET并解析响应"""
        params={
            "query":query,
            "top_k":top_k,
